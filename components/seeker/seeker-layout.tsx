...
const actionNav = [
  { name: "Feature Request", href: "/seeker/feature-request", icon: Sparkles, color: "bg-primary" },
]
    ...
    <div className="min-h-screen bg-background">
      <SkipLinks
        links={[
          ...
          { href: "#nav-counselors", label: "Skip to Find Counselors" },
        ]}
      />
        ...
        >
          <div className="p-4 flex flex-col h-full">
            ...
            <div className="flex items-center justify-between mb-8">
              {sidebarOpen && (
                <Link href="/seeker/dashboard" className="flex items-center gap-2 flex-1">
                  <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary flex-shrink-0">
                    <Heart className="h-5 w-5 text-primary-foreground" />
                  </div>
                  <span className="text-xl font-semibold tracking-tight hidden lg:inline">Harmony</span>
                </Link>
              )}
              <button
          ...
          <header className="sticky top-0 z-40 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <div className="flex h-16 items-center justify-between px-4 sm:px-6">
              <div className="flex items-center gap-4">
                ...
                <Link href="/seeker/dashboard" className="flex lg:hidden items-center gap-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56" align="end">
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/seeker/settings" className="flex items-center gap-2">
